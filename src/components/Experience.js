...
//       {/* Squares Background - using exact same configuration as About section */}
...
//           <div
//             key={exp.id}
//             className="mb-8 p-6 rounded-lg bg-white/90 backdrop-blur-sm text-black shadow-lg transition-all hover:bg-white"
//           >
//             <h3 className="text-2xl font-semibold mb-1">{exp.title}</h3>
//             <h4 className="text-xl text-black mb-1">{exp.company}</h4>
//             <p className="text-black/80 italic mb-3">{exp.duration}</p>
